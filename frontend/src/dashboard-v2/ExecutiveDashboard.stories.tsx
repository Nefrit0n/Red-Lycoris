...
import { TEMPLATE_EXECUTIVE } from "./layouts/templates";
import { widgetRegistry } from "./widgets/registry";

const meta: Meta = {
  title: "Dashboard v2/ExecutiveDashboard",
  parameters: {
    layout: "fullscreen",
  },
};
...
const ExecutiveDashboardCanvas = ({
  mode,
}: {
...
export const Loaded: Story = {
  render: () => <ExecutiveDashboardCanvas mode="loaded" />,
};

export const Empty: Story = {
  render: () => <ExecutiveDashboardCanvas mode="empty" />,
};

export const Error: Story = {
  render: () => <ExecutiveDashboardCanvas mode="error" />,
};
