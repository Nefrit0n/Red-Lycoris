...
CREATE INDEX IF NOT EXISTS idx_findings_tenant_severity_status
...
CREATE INDEX IF NOT EXISTS idx_findings_last_activity
...
CREATE INDEX IF NOT EXISTS idx_policy_results_subject_evaluated
    ON policy_results (subject_type, subject_id, evaluated_at DESC);

-- Index for finding_risk joins
CREATE INDEX IF NOT EXISTS idx_finding_risk_finding_id
...
CREATE INDEX IF NOT EXISTS idx_findings_fingerprint_trgm
...
CREATE INDEX IF NOT EXISTS idx_products_identifier_trgm
