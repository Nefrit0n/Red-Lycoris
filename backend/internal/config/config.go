...
func Load() Config {
	return Config{
		...
		DBName:                   getEnv("DB_NAME", "red_lycoris"),
		...
		ObjectStoreBucket:        getEnv("OBJECT_STORE_BUCKET", "red-lycoris"),
		...
		AnalysisTempDir:          getEnv("ANALYSIS_TEMP_DIR", "/tmp/red-lycoris-analysis"),
