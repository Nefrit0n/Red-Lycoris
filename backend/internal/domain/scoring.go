...
//
//	raw = cvss_base*0.30 + epss*100*0.25 + kev*10*0.20 + bdu*5*0.10 + recency*0.10 + exposure*0.05 + trend*0.05
//
...
func CalculatePriorityScore(baseScore, epssScore, epssTrend7d float64, isKEV, isBDU bool, daysOld float64) float64 {
	const exposure = 5.0
	const maxRaw = 33.25
